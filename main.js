...
dinoImg.src = './resources/dinosaur.png';

let dinoImg2 = new Image();
dinoImg2.src = './resources/dinosaur2.png';

let dinoDuck = new Image();
dinoDuck.src = './resources/dinoduck.png';

let dinoDuck2 = new Image();
dinoDuck2.src = './resources/dinoduck2.png';

let cactusImg = new Image();
cactusImg.src = './resources/cactus.png';

let birdImg = new Image();
birdImg.src = './resources/bird.png';

let birdImg2 = new Image();
birdImg2.src = './resources/bird2.png';

let cloudImg = new Image();
cloudImg.src = './resources/cloud.png';

let groundImg = new Image();
groundImg.src = './resources/ground.png';

// let themeMusic = new Audio('./theme.mp3');
let jumpEffect = new Audio('./resources/jump.mp3');
